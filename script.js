document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    "en": {
        ...
        "hero-lead": "5+ years of experience. Statistician and Data & Machine Learning Engineer. Specialized in building scalable cloud infrastructure, predictive models, and end-to-end data pipelines for complex financial and AI systems.",
        "role-sabadell": "Data Scientist & Data Hub Specialist",
        "role-orwee": "Co-Founder & Lead Data Engineer",
        ...
        "exp-orwee": "<strong>Infrastructure:</strong> Designed and deployed a full-stack cloud architecture (AWS) supporting a real-time ETL system that processes 50M+ on-chain data points.<br><strong>Product Innovation:</strong> Developed a custom Lending Risk Dashboard for concentrated liquidity, enabling real-time monitoring of protocol inflection points for 500+ active users.<br><strong>Advanced Analytics:</strong> Implemented Python-based ML algorithms to identify yield-optimization opportunities and funding-rate arbitrage across multiple chains.",
        ...
        "skill-lang-title": "Languages & Libraries:",
        "skill-lang-desc": "Python (Pandas, NumPy, Scikit-Learn, TensorFlow), SQL, SAS, R.",
    ...
    "es": {
        ...
        "hero-lead": "+5 años de experiencia. Estadístico y Data & Machine Learning Engineer. Especializado en construir infraestructura cloud escalable, modelos predictivos y pipelines de datos de principio a fin para sistemas financieros e IA complejos.",
        "role-sabadell": "Data Scientist & Data Hub Specialist",
        "role-orwee": "Co-Founder & Lead Data Engineer",
        "role-eagency": "Co-Founder / Marketing Specialist",
        ...
        "exp-orwee": "<strong>Infraestructura:</strong> Diseño y despliegue de arquitectura cloud full-stack (AWS) que soporta un sistema ETL en tiempo real, procesando más de 50M de datos on-chain.<br><strong>Innovación de Producto:</strong> Desarrollo de un Dashboard de Riesgo de Préstamos personalizado, permitiendo la monitorización en tiempo real de puntos de inflexión del protocolo para más de 500 usuarios activos.<br><strong>Analítica Avanzada:</strong> Implementación de algoritmos ML en Python para identificar oportunidades de yield y arbitraje de funding-rates en múltiples cadenas.",
...
"contact-cta": "¿Hablamos de tu proyecto?",
        ...
        "skill-lang-title": "Lenguajes y Librerías:",
        "skill-lang-desc": "Python (Pandas, NumPy, Scikit-Learn, TensorFlow), SQL, SAS, R.",
        "skill-model-title": "Analítica Avanzada:",
        "skill-model-desc": "Modelado Estadístico, Predicción de Series Temporales.",
        "skill-cloud-title": "Ingeniería de Datos y Cloud:",
        "skill-cloud-desc": "AWS (S3, Lambda, EC2), Docker, dbt, Pipelines ETL, CI/CD, n8n, REST APIs, Git/GitHub.",
        "skill-ai-title": "IA y Automatización:",
        "skill-ai-desc": "Integración de Agentes de IA y LLMs, Automatización de Flujos de Trabajo, Machine Learning.",
