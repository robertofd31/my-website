document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    "es": {
        ...
        "exp-orwee": "<strong>Infraestructura:</strong> Diseño y despliegue de arquitectura cloud full-stack (AWS) que soporta un sistema ETL en tiempo real, procesando más de 50M de datos on-chain.<br><strong>Innovación de Producto:</strong> Desarrollo de un Dashboard a medida de Riesgo de Préstamos que permite monitorizar en tiempo real los puntos críticos del protocolo, dando servicio a más de 500 usuarios activos.<br><strong>Analítica Avanzada:</strong> Implementación de algoritmos ML en Python para identificar oportunidades de yield y arbitraje de funding-rates en múltiples cadenas.",
