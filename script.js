document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "exp-eagency": "Founder of a digital marketing agency focused on automating marketing and sales processes. Delivered custom web designs and optimized ad campaigns, integrating CRM systems and automated workflows.",
    ...
    es: {
      ...
      "exp-eagency": "Fundador de una agencia de marketing digital enfocada en automatizar procesos de marketing y ventas. Implementé diseños web personalizados y optimicé campañas publicitarias, integrando sistemas CRM y flujos automatizados.",
