document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "exp-eagency": "Founder of a digital marketing agency. Developed custom web solutions and <strong>automated business processes</strong>. <strong>Implemented web analytics</strong> (Google Analytics), <strong>advanced tracking integrations</strong>, and <strong>A/B testing</strong> to optimize ad campaigns, alongside creating <strong>CRM workflows</strong> to scale client operations.",
    ...
    es: {
      ...
      "exp-eagency": "Fundador de una agencia de marketing digital. Desarrollé soluciones web a medida y <strong>automaticé procesos de negocio</strong>. <strong>Implementé estrategias de analítica web</strong> (Google Analytics), <strong>integraciones de trackeo avanzado</strong> y <strong>A/B testing</strong> para optimizar campañas publicitarias, además de crear <strong>flujos en sistemas CRM</strong> para escalar operaciones.",
