document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "exp-eagency": "Founder of a digital agency. Developed custom web solutions and automated business processes. Implemented data analysis via Google Analytics to optimize ad campaigns, and created workflows and CRM systems to scale client operations.",
    ...
    es: {
      ...
      "exp-eagency": "Fundador de una agencia digital. Desarrollé soluciones web a medida y automaticé procesos de negocio. Implementé análisis de datos en Google Analytics para optimizar campañas publicitarias y creé flujos de trabajo en sistemas CRM para escalar operaciones de clientes.",
