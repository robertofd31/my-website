document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "exp-eagency": "Founder of a digital marketing agency. Developed custom web solutions and automated business processes. Implemented web analytics (Google Analytics), advanced tracking integrations, and A/B testing to optimize ad campaigns, alongside creating CRM workflows to scale client operations.",
    ...
    es: {
      ...
      "exp-eagency": "Fundador de una agencia de marketing digital. Desarrollé soluciones web a medida y automaticé procesos de negocio. Implementé estrategias de analítica web (Google Analytics), integraciones de trackeo avanzado y A/B testing para optimizar campañas publicitarias, además de crear flujos en sistemas CRM para escalar operaciones.",
