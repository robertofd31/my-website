document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "proj-orwee-desc": "A comprehensive DeFi terminal for decentralized finance analytics. Features include a Liquidity Pools Explorer, portfolio tracking, and Funding Rate Arbitrage, processing over 50M data points to deliver real-time institutional insights.",
      ...
      "proj-antipasivo-desc": "Development of custom Dashboards for crypto educational academies. Real-time analysis of market opportunities and on-chain tools for students and investors.",
      "exp-eagency": "Founder of a digital marketing agency. Developed custom web solutions and <strong>automated business processes</strong>. Implemented web analytics (<strong>Google Analytics</strong>), <strong>advanced tracking integrations</strong>, and <strong>A/B testing</strong> to optimize ad campaigns, alongside creating <strong>CRM workflows</strong> to scale client operations.",
    ...
    es: {
      ...
      "proj-heroes-desc": "Desarrollo de un dashboard centralizado para rastrear KPIs y métricas principales utilizadas en clase, proporcionando a estudiantes e instructores un único punto de verdad para el análisis del mercado cripto.",
      ...
      "proj-antipasivo-desc": "Desarrollo de Dashboards personalizados para academias educativas cripto. Análisis en tiempo real de oportunidades de mercado y herramientas on-chain para estudiantes e inversores.",
      "exp-eagency": "Fundador de una agencia de marketing digital. Desarrollé soluciones web a medida y <strong>automaticé procesos de negocio</strong>. Implementé estrategias de analítica web (<strong>Google Analytics</strong>), <strong>integraciones de trackeo avanzado</strong> y <strong>A/B testing</strong> para optimizar campañas publicitarias, además de crear <strong>flujos en sistemas CRM</strong> para escalar operaciones.",
